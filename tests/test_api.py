...
from app.dbmodels import User, Role, Post, Comment


# 测试系统-flask测试客户端:测试web服务
class APITestCase(unittest.TestCase):
    ...
    def test_posts(self):
        ...
        self.assertEqual(json_response.get('count', 1), 1)
        self.assertEqual(json_response['posts'][0], json_post)

        # get the post from the user as a follower  ------ 這部分代碼有些問題
        # response = self.client.get(
